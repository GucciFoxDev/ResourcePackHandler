...
import me.ozyrncraft.utils.Utils;
...
public class ExtractingUtils {
    ...
    public static final File UPLOADED_PACK_FOLDER = new File(Objects.requireNonNull(PackHandler.getConfiguration().getString("uploaded-resource-pack-folder")));
